package com.es2projeto.es2eventos.palestra.controllers;
...
public class PalestraController {
	...
	@GetMapping("/proximas")
    public ResponseEntity<List<PalestraDTO>> getProximasPalestras() {
        List<PalestraDTO> list = service.findProximas();
